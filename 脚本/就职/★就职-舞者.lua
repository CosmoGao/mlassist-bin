...
::begin::	
	等待空闲()
	mapNum=取当前地图编号()
	if(mapNum==41017)then goto map41017 end
	if(mapNum==41016)then goto map41016 end
...
::map41016::		--波雷波雷号
	...
	if(是否转职)then
		...
		转向(0)
		等待服务器返回()
		对话选择(0,1)			--转职1  就职0 提升2
		等待服务器返回()
		对话选择(0,0)	
		等待(2000)
		自动寻路(27,21)
		common.learnPlayerSkill(2)
		自动寻路(25,20)
		对话选是(24,19)
	else
		日志("到达目标地点，请手动转职和学习技能，脚本退出",1)
		return
	end
::map41017::		--波雷波雷号 客房
	自动寻路(11,10)
