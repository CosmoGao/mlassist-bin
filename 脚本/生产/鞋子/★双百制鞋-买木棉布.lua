造光之鞋卖店，要求：会狩猎伐木，设好自动战斗，启动脚本时物品栏全空，自动扔东西（包括魔石/各种卡片/各种碎片），自动治疗!以及自动叠加 鹿皮&40 木棉布&20 木棉布&20 毛毡&20 鹿皮不要捡多了，会卡住
...
local shoeTbl={material="木棉布",playerName=人物("名称",false),materialCount=20,cmd=""}	--发送当前需要的材料 数量
local 木棉布数量=200 --10组
local lastCount=0	--上次木棉布数量
