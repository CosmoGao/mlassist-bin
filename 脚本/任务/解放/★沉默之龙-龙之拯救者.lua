...
::map44000::					--贝尼恰斯火山 地下2楼
	自动寻路(99,40,"贝尼恰斯火山地下3楼")
::map48001::					--贝尼恰斯火山地下3楼
	自动寻路(56,37,"贝尼恰斯火山地下4楼")
::map48002::
	自动寻路(51,52,"贝尼恰斯火山地下5楼")
::map48003::
	自动寻路(55,50,"贝尼恰斯火山地下6楼")
::map48004::
	自动寻路(56,70,"贝尼恰斯火山地下7楼")
::map48005::
	自动寻路(58,57,"贝尼恰斯火山地下8楼")
::map48006::							
	自动寻路(30,49,"贝尼恰斯火山地下9楼")
::map48007::							--1级烟罗
	自动寻路(20,46,"贝尼恰斯火山 地下10楼")
::map48008::							--贝尼恰斯火山 地下10楼
	自动寻路(24,47,"贝尼恰斯火山 最下层")
::map48011::
	自动寻路(77,38)
	自动寻路(75,38)
	自动寻路(77,38)
...
::map46016::				--艾儿卡丝之家
	if(取物品数量("赛米列的记事纸条") > 0) then		--去2楼 干白银团长
		...
		elseif(目标是否可达(17,34))then
			自动寻路(17,34,"艾儿卡丝之家 地下1楼")	
		elseif(目标是否可达(28,24))then
			自动寻路(28,24,"艾儿卡丝之家 2楼")
		end		
	else
		自动寻路(24,2,"食堂")
	end
...
::map46020::
	if(目标是否可达(8,5))then
		自动寻路(8,5,"艾儿卡丝之家 地下1楼")
	elseif(目标是否可达(48,3))then
		自动寻路(56,40,"艾儿卡丝之家 地下1楼")
	end		
	goto begin
