...
队长名称=取脚本界面数据("队长名称",false)	--false是不转换成数字 默认字符串
队伍人数=取脚本界面数据("队伍人数")
设置队员列表=取脚本界面数据("队员列表")
队员列表=nil
...
走路加速值=110				--脚本走路中可以设定移动速度  到达目的地后，再还原值即可 不要超125  
走路还原值=100				--防止掉线 还原速度
身上最少金币=5000			--少于去取
身上最多金币=1000000		--大于去存
身上预置金币=500000			--取和拿后 身上保留金币
脚本运行前时间=os.time()	--统计效率
脚本运行前金币=人物("金币")	--统计金币
已刷签名数量=0				--统计刷签名总数
医生名称={"星落护士","谢谢惠顾☆"}	--自定义医生 优先找自己的
水晶名称="水火的水晶（5：5）"	--指定水晶名称
上次迷宫楼层=nil			--迷宫判断正反
当前迷宫楼层=nil			--迷宫判断正反
