★定居艾岛；支持法兰，F深蓝、哈密瓜、飞行劵、火焰之魂 G鼠王 H抽奖，银行满以后丢弃★坐标180秒未变重启	★脚本联系：风星落-QQ:274100927
...
设置("自动叠",1,"香水：深蓝九号&3|火焰之魂&5|魅惑的哈密瓜&3")
设置("自动扔",1,"34754|迷之手册|迷之晶体|鼠娃娃兑换券|魅惑的哈密瓜|魅惑的哈密瓜面包|印度轻木|34583|34584|34585|34586|蕃茄|封印卡（昆虫系）|封印卡（野兽系)|封印卡（人形系）|封印卡（金属系）|封印卡（龙系）|封印卡（特殊系）|封印卡（植物系）|封印卡（飞行系）|封印卡（不死系）|鼠王的卡片|鹿皮|鸡蛋|铜|苹果薄荷|勾玉的戒指|宝石鼠洋娃娃|大地鼠洋娃娃|火焰鼠洋娃娃|恶梦鼠洋娃娃|试验红药水|面包|特制雕鱼烧|生命力回复药（75）")
...
预置交易物品列表={"小护士家庭号","魔力之泉","完全结晶体的紫水晶","完全结晶体的骑士宝石","完全结晶体的绿宝石","火焰鼠闪卡「B4奖」","火焰鼠闪卡「B3奖」","火焰鼠闪卡「B2奖」","火焰鼠闪卡「B1奖」","火焰鼠闪卡「A4奖」","火焰鼠闪卡「A3奖」","火焰鼠闪卡「A2奖」","火焰鼠闪卡「A1奖」","宝石鼠月亮奖","海洋之心","火焰之魂","香水：深蓝九号","天空之枪","帕鲁凯斯之斧","村正","鼠王"}	
local tradeName=nil
...
function openEgg()
	local tryNum=0
	while 取物品数量("鼠王惊奇蛋") > 0 and tryNum < 100 do 
		使用物品("鼠王惊奇蛋")
		对话选择(1,0)
		tryNum=tryNum+1
	end
	...
	if(tradeName ~= nil and tradeBagSpace ~= nil)then	
		...
		for i,v in pairs(items) do
			if(common.isInTable(预置交易物品列表,v.name) or
				(v.name=="火焰之魂" and v.count==5)or
				(v.name=="魔族的水晶" and v.count==5) or
				(v.name=="香水：深蓝九号" and v.count==3))then
				if(hasData)then
