...
local isSuccessed=false		--是否成功鉴定过
	
local 指定5硬币数量去兑换=500		--500个5硬币 去兑换大面值
local 指定10硬币数量去兑换=500		--500个10硬币 去兑换大面值
local 指定1000硬币数量去兑换=20		--20个1000硬币 去兑换大面值
local 指定10000硬币数量去兑换=20		--20个10000硬币 去兑换大面值
...
::补魔::	
	...
	if(取物品叠加数量("５怪物硬币")>= 100 or 取物品叠加数量("１怪物硬币")>= 50)then
		...
		if(检查银行硬币数量())then 
			...
			转向(2)
			等待服务器返回()	
			日志("银行5怪物硬币:"..取银行物品叠加数量("５怪物硬币").." 1000硬币:"..取银行物品叠加数量("１０００怪物硬币").." 1W硬币:"..取银行物品叠加数量("１万怪物硬币"),1)
...
::map59825::
	...
	转向(2)
	等待服务器返回()
	日志("银行5怪物硬币:"..取银行物品叠加数量("５怪物硬币").." 1000硬币:"..取银行物品叠加数量("１０００怪物硬币").." 1W硬币:"..取银行物品叠加数量("１万怪物硬币").." 10W硬币:"..取银行物品叠加数量("１０万怪物硬币"),1)
end
function 检查银行硬币数量()
	local needExchange=false
	if(取银行物品叠加数量("５怪物硬币") >= 指定5硬币数量去兑换 )then 	
		needExchange=true
	elseif( 取银行物品叠加数量("１０怪物硬币") >= 指定10硬币数量去兑换 )then 	
		needExchange=true
	elseif( 取银行物品叠加数量("１０００怪物硬币") >= 指定1000硬币数量去兑换 )then 	
		needExchange=true
	elseif( 取银行物品叠加数量("１万怪物硬币") >= 指定10000硬币数量去兑换 )then 	
		needExchange=true	
	end	
	return needExchange
end
